      ...
      <div className="space-y-8 max-w-2xl">
        ...
        <section>
          ...
          <div className="space-y-4">
            <div>
              ...
              <input id="displayName" type="text" defaultValue={user?.fullName || user?.email?.split('@')[0] || ''} className="w-full px-3 py-2 rounded-lg bg-surface border border-hairline text-foreground focus:outline-none focus:ring-2 focus:ring-primary/50" />
            </div>
            <div>
              <label htmlFor="settings-email" className="block text-sm text-muted-foreground mb-1.5">Email</label>
              <input id="settings-email" type="email" defaultValue={user?.email || ''} className="w-full px-3 py-2 rounded-lg bg-surface border border-hairline text-foreground focus:outline-none focus:ring-2 focus:ring-primary/50" />
            </div>
          </div>
        </section>
        {/* Appearance */}
        ...
        <section>
          ...
          <div className="rounded-xl border border-danger-border bg-danger-bg p-5">
            ...
            <button type="button" className="px-4 py-2 rounded-lg bg-danger-fg text-background text-sm font-medium hover:opacity-90 transition-opacity">Delete workspace</button>
          </div>
        </section>
      </div>
    </div>
