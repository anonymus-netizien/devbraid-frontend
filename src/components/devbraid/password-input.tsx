    ...
    return (
      <div className="relative">
        <input
          ...
          className={cn(
            'h-10 w-full rounded-md border bg-surface/60 px-4 pr-11 text-base text-foreground placeholder:text-muted-foreground/50 outline-none transition-all duration-200',
