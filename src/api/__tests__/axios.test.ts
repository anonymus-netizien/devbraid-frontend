...
mock.module("../axios", () => {
  ...
  const interceptors = {
    request: { handlers: [] as Array<{ fulfilled: Function; rejected?: Function }>, use: function (f: Function, r?: Function) { this.handlers.push({ fulfilled: f, rejected: r }); return this.handlers.length - 1; }, count: function () { return this.handlers.length; } },
    response: { handlers: [] as Array<{ fulfilled: Function; rejected?: Function }>, use: function (f: Function, r?: Function) { this.handlers.push({ fulfilled: f, rejected: r }); return this.handlers.length - 1; }, count: function () { return this.handlers.length; } },
  };
  ...
  const requestInterceptor = (config: any) => {
    const token =
      typeof localStorage !== "undefined"
        ? localStorage.getItem("devbraid_access_token")
        : null;
  ...
  const responseInterceptorError = async (error: any) => {
    ...
    if (
      ...
      const refreshToken =
        typeof localStorage !== "undefined"
          ? localStorage.getItem("devbraid_refresh_token")
          : null;
